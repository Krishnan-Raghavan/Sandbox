...
A living reference of Krishnan Raghavan's GitHub account (`Krishnan-Raghavan`),
...
| `agent-modes-templates` | Shell | Agent/prompt mode templates |
| `chatmodes` | — | 30+ custom AI agent prompts for VS Code workflows |
| `Krishnan-Raghavan` | — | GitHub profile README repo |
| `Logparser` | Java | Log file parsing assignment |
| `iDDay1` | TypeScript (private) | Interactive Design Challenge day 1 |

## Forked repos (reference material, not original work)
